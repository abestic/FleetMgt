...
class ManagersControllerTest < ActionController::TestCase
  ...
  test "should create manager" do
    assert_difference('Manager.count') do
      post :create, manager: { Active: @manager.Active, First_Name: @manager.First_Name, Last_Name: @manager.Last_Name, email: @manager.email }
    end
  ...
  test "should update manager" do
    put :update, id: @manager, manager: { Active: @manager.Active, First_Name: @manager.First_Name, Last_Name: @manager.Last_Name, email: @manager.email }
    assert_redirected_to manager_path(assigns(:manager))
  end
